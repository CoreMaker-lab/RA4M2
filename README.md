...
- **RA2E1_project12**:e2studio开发RA4M2(12)----打印函数(printf、 sprintf)的实现
...
- **RA2E1_project13**:e2studio开发RA4M2(13)----串口接收数据
...
- **RA2E1_project14**:e2studio开发RA4M2(14)----IIC驱动水压计LPS28DFW
...
- **RA2E1_project15**:e2studio开发RA4M2(15)----配置RTC时钟及显示时间
...
- **RA2E1_project16**:e2studio开发RA4M2(16)----ADC单通道采集电压
...
- **RA2E1_project17**:e2studio开发RA4M2(17)----ADC扫描多通道采样
