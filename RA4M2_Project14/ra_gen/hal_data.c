...
const sci_i2c_extended_cfg_t g_i2c2_cfg_extend =
        {
          /* Actual calculated bitrate: 187500. Actual SDA delay: 333.3333333333333 ns. */.clock_settings.clk_divisor_value =
                  0,
          .clock_settings.brr_value = 0,
...
{ .channel = 2, .rate = I2C_MASTER_RATE_FAST, .slave = 0x5c, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
