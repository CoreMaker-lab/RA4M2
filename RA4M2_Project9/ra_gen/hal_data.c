        ...
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          ...
          .capture_b_source = (gpt_source_t) (
                  GPT_SOURCE_GTIOCB_RISING_WHILE_GTIOCA_LOW | GPT_SOURCE_GTIOCB_RISING_WHILE_GTIOCA_HIGH
                          ...
                          | GPT_SOURCE_NONE),
          .capture_a_ipl = (BSP_IRQ_DISABLED), .capture_b_ipl = (2),
...
/* Actual period: 0.010922666666666667 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x10000,
...
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x1770,
