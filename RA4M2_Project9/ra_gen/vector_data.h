...
#define VECTOR_NUMBER_GPT2_CAPTURE_COMPARE_B ((IRQn_Type) 4) /* GPT2 CAPTURE COMPARE B (Capture/Compare match B) */
#define GPT2_CAPTURE_COMPARE_B_IRQn          ((IRQn_Type) 4) /* GPT2 CAPTURE COMPARE B (Capture/Compare match B) */
#ifdef __cplusplus
        }
        #endif
#endif /* VECTOR_DATA_H */
