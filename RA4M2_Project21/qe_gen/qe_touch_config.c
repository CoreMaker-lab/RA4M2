...
***********************************************************************************************************************/
/***********************************************************************************************************************
* Touch I/F Configuration File  : RA4M2_Project21.tifcfg
* Tuning Log File               : RA4M2_Project21_log_tuning20250304003830.log
***********************************************************************************************************************/
...
{
    { .ssdiv = CTSU_SSDIV_0670, .so = 0x052, .snum = 0x01, .sdpa = 0x01 },
    { .ssdiv = CTSU_SSDIV_0670, .so = 0x06E, .snum = 0x01, .sdpa = 0x01 },
};
